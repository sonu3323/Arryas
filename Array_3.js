 ...
 * Exercise 01
 *
 * TODO => Check whether every email address in the list of users is valid (get a true or false value)
 */
 ...
 * Exercise 02
 *
 *TODO => Find out how many users have an IP address in a Class A network
 ...
 * Exercise 03
 *
 *TODO => Find the position in the array of the first  user object that has a Class B IP address
 */
 ...
 * Exercise 04
 *
 *TODO => Find the user object that has the 'soundcloud' email address
 */
 ...
 * Exercise 05
 *
 *TODO => Replace all the items in the array with a string value of 'deleted'
 */
